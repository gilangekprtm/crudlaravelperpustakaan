                        ...
                        <div class="animated fadeIn">
                            ...
                            @endif
                                ...
                                <div class="card-header"> 
                                 ...
                                 <tr>
                                  <td><h5 class="card-title">Tambah Data Jenis Buku</span></h5></td>
                                  <td> 
                                    ...
                                    <div class="card-body">  
                                        ...
                                        <form action="{{ url('jenis')}}" method="post" enctype="multipart/form-data">
                                          ...
                                          <p>
                                              ...
                                              <div class="row mb-3">
                                                <label for="name" class="col-sm-2 col-form-label">Nama Jenis</label>
                                                <div class="col-sm-10">
                                                  <input type="text" class="form-control @error('nama_jenis') is-invalid @enderror"   value="{{ old('nama_jenis') }}"  name="nama_jenis"  required autofocus>
                                                </div>
                                              </div>
